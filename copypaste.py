...
def copy_paste_augmentation(annotations_source_cleaned,I_source,I_destination ):
...
# Get N source images
def generate_overlayed_frames(coco, I_destination, N_source_images=5, margin_ratio=0.05, inContact_ratio_limit=0.1 ):
  #N_source_images =5
  #margin_ratio=0.05,
  ...
  for i in range(N_source_images):
    ...
    if len(annotations_source_cleaned)> 0:
      augmented_image,augmented_mask, New_annotation = copy_paste_augmentation(annotations_source_cleaned,I_source,I_destination )
...
def overlay(I_destination,annotations_destination, Image_layers,Mask_layers, Added_annotations, N_source_images=5 ):
